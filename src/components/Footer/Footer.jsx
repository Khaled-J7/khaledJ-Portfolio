	...
	return (
		<footer className={styles.footer}>
				...
				<div className='row'>
					<div className='col-lg-5 mb-4 mb-lg-0'>
						...
						<p className={styles.description}>
							A passionate Full Stack Developer dedicated to crafting seamless
							and dynamic digital experiences from front-end to back-end.
						</p>
					</div>
					...
					<div className='col-lg-3'>
						<h3 className={styles.heading}>My Resume</h3>
						<a
							href={resumePDF}
			...
			<div className={styles.copyright}>
				&copy; {new Date().getFullYear()} Khaled Jallouli. All rights reserved.
			</div>
		</footer>
	);
};
